...
swift_container_size = prometheus_client.Gauge(
                 'swift_container_size_bytes', 'bytes', ['container'])


swift_container_count = prometheus_client.Gauge(
                 'swift_container_file_count', 'files', ['container'])
